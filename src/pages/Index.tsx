              ...
              <CardContent className="p-6">
                ...
                <Button 
                  ...
                  onClick={() => {
                    ...
                    window.open('https://pay.kirvano.com/55c837f8-deba-4a37-b02b-0de8669d336b', '_blank');
                  }}
                >
                  COMPRAR AGORA
                </Button>
              ...
              <CardContent className="p-6">
                ...
                <Button 
                  ...
                  onClick={() => {
                    ...
                    window.open('https://pay.kirvano.com/35376742-cfe7-46cb-a180-ececcf979048', '_blank');
                  }}
                >
                  COMPRAR AGORA
                </Button>
